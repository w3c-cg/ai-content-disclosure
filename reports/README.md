...
| IETF header proposal | [draft-abaris-aicdh](https://datatracker.ietf.org/doc/draft-abaris-aicdh/), author contact `draft-abaris-aicdh@ietf.org` | Share the final three values and required-review semantics; ask about maintenance and semantic alignment. As of preparation, this is an expired individual Internet-Draft, not an IETF standard or WG-adopted document. |
